# Install script for directory: /home/kristiyan/OpenDaVINCI/automotive/miniature/driver
...
if(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "software")
  ...
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/bin/miniature" TYPE EXECUTABLE FILES "/home/kristiyan/OpenDaVINCI/automotive/miniature/driver/build/driver")
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/miniature/driver" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/miniature/driver")
    file(RPATH_REMOVE
         FILE "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/miniature/driver")
...
file(WRITE "/home/kristiyan/OpenDaVINCI/automotive/miniature/driver/build/${CMAKE_INSTALL_MANIFEST}"
     "${CMAKE_INSTALL_MANIFEST_CONTENT}")
